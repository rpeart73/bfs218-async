...
(function () {
  ...
  function studyWeekPage(w) {
    ...
    var hero = '<section id="wk-ov" class="node jhero jfade" style="margin:0 0 16px"><div style="position:relative">'
      ...
      + '<p style="font-size:1.04rem;line-height:1.6;color:var(--ink);margin:0 0 4px;">Study Week runs October 26 to 30: no new readings and no new content here. Nothing is due during Study Week. The first half of the course closed on Sunday, October 25: the Map Exchange checkpoint, the Coded Encounter, and the Canadian Case File. Use the week to rest and let the first half settle.</p>'
  ...
  function keyDatesList() {
    ...
    return [
      ...
      { d: '2026-09-21', it: [['Map Exchange opens', '', 'open', 0], ['Coded Encounter opens', '', 'open', 1], ['Canadian Case File opens', '', 'open', 2]] },
