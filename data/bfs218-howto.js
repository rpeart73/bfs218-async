...
window.BFS218_HOWTO = {
 "byScreen": {
  "journey": {
   ...
   "steps": [
    ...
    },
    {
     ...
     "detail": "Each station shows its dates, how many readings it carries, and whether you have started it. The final project weeks carry no new material."
    },
    {
    ...
    },
    {
     ...
     "detail": "The orientation panel explains how to run a self-paced course well: you set the pace, the weekly experience carries the teaching, and you check your own understanding."
    },
    {
     "do": "Use the Study Compass.",
     "detail": "The compass box suggests what to do next based on what you have already done on this device. It is a suggestion, never a requirement. Adding your first name is optional."
    },
    {
   ...
   "steps": [
    {
     ...
     "detail": "It names the week's question and its route: Read, See, Try, Reflect. The Start button takes you to the right first section."
    },
    {
  ...
  "site": {
   ...
   "steps": [
    {
     "do": "Read the success guide first.",
     "detail": "Five habits for doing an asynchronous course well: plan your times, learn from the experience, quiz yourself honestly, have a plan for being stuck, and keep your own evidence."
    },
    {
    ...
    },
    {
     ...
     "detail": "You learn and practise here. You submit, discuss, and get grades on Blackboard. If the two ever disagree, Blackboard wins."
    },
    {
  ...
  "pathways": {
   ...
   "steps": [
    {
     "do": "Read the five moves of the weekly rhythm.",
     "detail": "Start with the weekly page, learn from the experience and readings, practise with the activity and checks, capture notes as you go, and finish by generating your weekly record."
    },
    {
    ...
    },
    {
     ...
     "detail": "Enter it first, then anchor its teaching in the readings. Re-enter it whenever you want to examine an idea again."
    },
    {
     "do": "Use the closing buttons to jump.",
   ...
   "steps": [
    {
     ...
     "detail": "Filter by week or by topic, or just scan the cards."
    },
    {
     "do": "Open a source's detail page.",
     "detail": "It shows the full citation, where to access it, roughly how long it takes, the core idea, and an evidence profile that names what the source does not prove."
    },
    {
     "do": "Open the reading itself.",
     "detail": "The read button opens the full text in a new tab. The site never hosts the reading; some sources go through Blackboard or the Seneca library."
    },
    {
     "do": "Use Source Practice on sources you have read.",
     "detail": "Pick one source, choose a lens, write your answers, then reveal what a strong response covers. Quick check questions tell you whether the reading actually landed."
    },
    {
     "do": "Add two or three sources to the compare tray.",
   ...
   "steps": [
    {
     ...
     "detail": "Use the picker on the right. Readings, videos, and audio can sit together, so choose sources that speak to the same question from different angles."
    },
    {
     "do": "Read the side-by-side panels.",
     "detail": "Each panel keeps the source's core idea, its evidence type, and what it does not prove visible."
    },
    {
     "do": "Press Synthesize when you are ready.",
     "detail": "The synthesis builds a frame across your chosen sources. Use it as a thinking scaffold, not as sentences to copy."
    },
    {
  ...
  "walkthroughs": {
   ...
   "steps": [
    ...
    },
    {
     ...
     "detail": "Each slide is one move: a scene, an evidence room, a decision, or a diagram. The bar at the top shows your progress."
    },
    {
     "do": "Open Accessibility for narration and text size.",
     "detail": "Voice narration reads the current chapter with a voice and speed you choose. The text size controls are in the header. All of it is optional."
    },
    {
   ...
   "steps": [
    {
     ...
     "detail": "The lecture keeps playing while you move around the site, so you can listen while you read or review."
    },
    {
     "do": "Use the mini player.",
     "detail": "While a lecture plays, a small player stays on screen. It can pause, jump you to that week's page, or close."
    },
    {
     "do": "Open the week for the full player.",
     "detail": "The week page adds skip, speed, download, a follow-along transcript, and other narration voices and languages. Download before you travel; the subway has no signal."
    },
    {
     "do": "Treat it as a companion, not a substitute.",
  ...
  "videos": {
   ...
   "steps": [
    {
     "do": "Filter by week or by kind.",
     "detail": "Each card names the scholar, what the item explains, and why it is worth your minutes."
    },
    {
     "do": "Play inside the page or follow the link out.",
     "detail": "Embeddable videos use official platform players and nothing loads until you press play. Podcasts and restricted media link out to the source site."
    },
    {
     "do": "Use the watch-for prompts.",
     "detail": "Each card tells you what to watch or listen for, and which reading move to make next. A talk is a way into a source, not a replacement for reading it."
    },
    {
     "do": "Write the note on the card.",
   ...
   "steps": [
    {
     ...
     "detail": "Terms are written in full sentences, enough to actually understand, and each carries the citation it comes from."
    },
    {
     "do": "Use terms to speak precisely.",
     "detail": "Ideas like the New Jim Code and intersectionality do exact work in this course. Written work reads stronger when the vocabulary is used accurately."
    },
    {
     "do": "Meet the scholars.",
     "detail": "Each week lists the scholars behind its readings, with a one-line version of what each argues. Click a name to open the source's detail page."
    },
    {
  ...
  "cards": {
   ...
   "steps": [
    ...
    {
     "do": "Work the Self-Check Studio above the cards.",
     "detail": "It turns the week's readings into a short see-it-for-yourself check, so you test the idea, not just the wording."
    },
    {
  ...
  "assignments": {
   ...
   "steps": [
    ...
    },
    {
     ...
     "detail": "Each room shows the purpose, what to submit, the marking criteria, and your program connection. Separate pages cover how stronger work grows, release dates, AI use, and the FAQ."
    },
    {
     "do": "Set your program lens for examples.",
     "detail": "The lens tailors the rooms and starter questions to your field. It never changes the prompt, the grading, or the due dates."
    },
    {
  ...
  "career": {
   ...
   "steps": [
    ...
    {
     "do": "Work the systems and the scenario.",
     "detail": "Each field names the systems to watch, the artifacts that count as evidence, and a concrete picture of the course ideas operating in that world."
    },
    {
   ...
   "steps": [
    {
     ...
     "detail": "Commit to one of the predictions, then press run. The gap between your guess and the outcome is where the learning is, so do not skip the commit."
    },
    {
     "do": "Read the reveal and the mirror.",
    ...
    },
    {
     ...
     "detail": "Every choice gives instant feedback: match examples to mechanisms, make decisions, flip defaults, assemble a system, or weigh policy levers. Week 5's activity is a bias audit that re-enacts Buolamwini and Gebru's Gender Shades study, and it can save your audit as a Word file."
    },
    {
     "do": "Write the activity note before you leave.",
  ...
  "calendar": {
   ...
   "steps": [
    ...
    },
    {
     ...
     "detail": "It opens that assignment's page so you can see what the date actually asks of you."
    },
    {
     "do": "Subscribe on your phone.",
     "detail": "The subscription is a live calendar feed, not a downloaded copy. Your calendar app can refresh it if the course schedule changes."
    },
    {
